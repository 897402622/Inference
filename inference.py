...
parser.add_argument("--pth_dirs", default=['WideIRSTD/ISTDU-Net_150.pth.tar'], nargs='+',  help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
...
def test(): 
    ...
    test_loader = DataLoader(dataset=test_set, num_workers=16, batch_size=16, shuffle=False)
