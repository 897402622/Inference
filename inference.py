...
parser.add_argument("--pth_dirs", default=['./ISTDU-Net_110.pth.tar'], nargs='+',  help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
