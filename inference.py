...
def test(): 
    ...
    net4.load_state_dict(torch.load("./log/WideIRSTD/PRCV/DNANet.pth.tar")['state_dict'])
    net4.eval()

    net5 = Net(model_name='RDIAN', mode='test').cuda()
    net5.load_state_dict(torch.load("./log/WideIRSTD/PRCV/RDIAN.pth.tar")['state_dict'])
    net5.eval()
    # try:
