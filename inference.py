...
parser.add_argument("--pth_dirs", default=['WideIRSTD/ISTDU-Net.pth.tar'], nargs='+',  help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
            ...
            if size[0] >=1536 or size[1]>=1536:
                ...
                for i in range(0, h, 512):
                    for j in range(0, w, 512):
                        ...
                        #sub_pred = torch.max(torch.max(torch.max(sub_pred1, sub_pred2), sub_pred3), sub_pred4)
